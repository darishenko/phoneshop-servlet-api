...
public class DefaultRecentProductsServiceTest {
    ...
    private static final Product product = new Product("sgs", "Samsung Galaxy S", new BigDecimal(100),
            Currency.getInstance("USD"), 100, "Samsung%20Galaxy%20S.jpg");
    ...
    @Test
    public void addToRecentProducts_nonexistentProductInRecent_addProductInRecentProducts() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    public void addToRecentProducts_existingProductInRecent_addProductInRecentProductsAsLast() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    public void addToRecentProducts_maxRecentProductsCount_deleteFirstProductFromRecentProducts() throws NoSuchFieldException, IllegalAccessException {
        recentProducts.getProducts().add(new Product());
        recentProducts.getProducts().add(new Product());
        recentProducts.getProducts().add(new Product());
        int recentProductsCount = recentProducts.getProducts().size();
